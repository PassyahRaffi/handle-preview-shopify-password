...
export default function Slug() {
  ...
  return (
    <div className="container max-w-[1200px] mx-auto px-4 max-h-screen">
      <div className="flex text-center justify-center items-center min-h-screen">
        <div className="flex gap-10 flex-col rounded-lg px-20 py-32 shadow-lg bg-neutral-100">
          <h2 className="text-lg lg:text-xl">
            Please enter the following password, <br /> after you click copy
            password
          </h2>
          <div className="relative py-2 border border-black rounded-lg">
